# This is my package laravel-casework
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-casework.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-casework)
...
```bash
php artisan vendor:publish --tag="laravel-casework-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-casework-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-casework-views"
```

## Usage

```php
$casework = new Syriable\Casework();
echo $casework->echoPhrase('Hello, Syriable!');
```
